...
===============================================
Requirements for scikit-surgerytutorial02-test
===============================================

This is the software requirements file for scikit-surgerytutorial02-test, part of the
SNAPPY project. The requirements listed below should define
what scikit-surgerytutorial02-test does. Each requirement can be matched to a unit test that
